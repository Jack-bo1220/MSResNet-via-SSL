...
#from unet.bn_helper import BatchNorm2d, BatchNorm2d_class, relu_inplace
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        ALIGN_CORNERS=True
        # stem net
        self.conv1 = nn.Conv2d(4, 64, kernel_size=3, stride=2, padding=1,#4代表波段
                               bias=False)
    ...
    def forward(self, x):
        ...
        x = self.layer1(x)
        #print(x.shape)
        #x = F.upsample(x, size=(448, 448), mode='bilinear')
        x_list = []
        ...
        #out = F.interpolate(out, size=(224, ), mode='bilinear', align_corners=ALIGN_CORNERS)
